...
class FileWrapper:
    ...
    def get_current_line(self):
        "return the current line, this might just be for debugging."
    ...
    def next(self) -> str:
        ...
        try:
            try:
                line = next(self.files[self.file_pointer]) ## it's not clear to me how this is the iterator and not something internally defined.
    ...
    def readline(self) -> str: ## why do we next and readline?
        """
